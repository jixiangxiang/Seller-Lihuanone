...
public class AllBillsActivity extends ListActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		simpleAdapter = new SimpleAdapter(this, listItems,
				R.layout.bill_list_detail, new String[] { "orderNO", "type",
						"createTime", "num", "total", "nickname" }, new int[] {
						R.id.order, R.id.type, R.id.time, R.id.num, R.id.total,
						R.id.nickname });
